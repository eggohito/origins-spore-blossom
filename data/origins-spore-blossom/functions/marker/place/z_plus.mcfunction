...
summon item_frame ~ ~ ~ {Tags: ["o-s-b.marker", "o-s-b.marker_init", "o-s-b.marker_immature", "o-s-b.marker_z_plus"], Item: {id: "minecraft:peony", Count: 1b, tag: {CustomModelData: 1}}, Invisible: 1b, Facing: 3b, Fixed: 1b}
