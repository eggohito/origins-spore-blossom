...
#
execute if score $rootAltSound o-s-b matches 1.. run summon evoker_fangs ~ ~ ~ {Tags: ["o-s-b.chomper", "o-s-b.chomper_init", "o-s-b.chomper_play_sound"], Silent: 1b}

execute if score $rootAltSound o-s-b matches ..0 run summon evoker_fangs ~ ~ ~ {Tags: ["o-s-b.chomper", "o-s-b.chomper_init"], Silent: 0b}
